"""Создаёт исходную схему данных приложения.
...
# Идентификаторы revision, используемые Alembic.
...
def upgrade() -> None:
    """Создаёт таблицы, связи, ограничения и индексы исходной схемы."""
    op.create_table(
        "keywords",
...
def downgrade() -> None:
    """Удаляет исходную схему в порядке, безопасном для внешних ключей."""
